...
public class testing {
	...
	public void ModelTest() {
		...
		assertEquals(testModel.player.getxloc(),102);
		assertEquals(testModel.player.getyloc(),102);
		assertEquals(testModel.scoringObjList.get(0).xloc,102);
		assertEquals(testModel.scoringObjList.get(0).yloc,102);
		assertEquals(testModel.scoringObjList.get(1).xloc,98);
		assertEquals(testModel.scoringObjList.get(1).yloc,98);
		testModel.updateGame();
		assertEquals(testModel.player.getxloc(),104);
		assertEquals(testModel.player.getyloc(),104);
		assertEquals(testModel.scoringObjList.get(0).xloc,104);
		assertEquals(testModel.scoringObjList.get(0).yloc,104);
		assertEquals(testModel.scoringObjList.get(1).xloc,96);
		assertEquals(testModel.scoringObjList.get(1).yloc,96);
	}
}
